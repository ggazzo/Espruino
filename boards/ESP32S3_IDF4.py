...
def get_pins():
  ...
  pinutils.findpin(pins, "PD5", True)["functions"]["ADC1_IN5"]=0;
  pinutils.findpin(pins, "PD6", True)["functions"]["ADC1_IN6"]=0;
  pinutils.findpin(pins, "PD7", True)["functions"]["ADC1_IN7"]=0;
